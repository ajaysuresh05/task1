...
class _SignUppState extends State<SignUpp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 30,right: 30),
            child: TextField(decoration: InputDecoration(border: OutlineInputBorder(),hintText: "Enter password"),),
          ),
    Padding(
    padding: const EdgeInsets.only(top:35,left: 40),
    child: Row(
    ...
    Padding(
      ...
      child: Container(
      width: double.maxFinite,height: 60,decoration: BoxDecoration(color: Colors.red,borderRadius: BorderRadius.circular(35)),
